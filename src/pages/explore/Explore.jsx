                ...
                <div className="pageHeader">
                    ...
                    <div className="filters">
                        <Select
                            ...
                            name="genres"
                            value={genre} // thay đổi giá trị tương ứng khi chọn 1 item
                            closeMenuOnSelect={false} //khi chon xong co mat select k
                            options={genresData?.genres} // đưa ra nhưng option để lựa chọn
                            getOptionLabel={(option) => option.name}
                            getOptionValue={(option) => option.id}
                            onChange={onChange}
                            placeholder="Select genres" // giống placeholder của input
